...
public class HttpProxyBackup {
	 ...
	 */
	public HttpProxyBackup(String host, int port, String username, String password) {
	 ...
	 */
	public HttpProxyBackup(String host, int port) {
	 ...
	 * @param source The proxy source.
	 */
	public HttpProxyBackup(ProxyType type, String host, int port) {
	 ...
	 * @param password The authentication password.
	 */
	public HttpProxyBackup(ProxyType type, String host, int port, String username, String password) {
		this.type = type;
		this.host = host;
		this.port = port;
